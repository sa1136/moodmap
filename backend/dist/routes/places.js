...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (process.env.OPENAI_API_KEY) {
            ...
            recommendedPlaces = getMockPlaces(mood, cityName);
            return res.json({
                places: recommendedPlaces,
        ...
        const fallbackPlaces = getMockPlaces(mood, fallbackCityName);
        return res.json({
 ...
 */
function getAllMockPlaces(city) {
 ...
 */
function getMockPlaces(mood, city) {
    const cityName = city || "your city";
    let normalizedMood = (mood === null || mood === void 0 ? void 0 : mood.toLowerCase().trim()) || '';
    const moodMap = {
        'relaxed': 'relaxed',
        'energetic': 'energetic',
 ...
 */
function getMockPlacesByMood(mood, city) {
    const cityName = city || "your city";
    const normalizedMood = mood === null || mood === void 0 ? void 0 : mood.toLowerCase();
    const mockPlaces = {
        happy: [
            {
                id: 1,
    ...
    const selectedPlaces = mockPlaces[normalizedMood];
    if (selectedPlaces) {
